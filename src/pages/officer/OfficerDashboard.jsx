  ...
  return (
    <Stagger className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <FadeIn><StatCard icon={Clock} label="Pending" value={pending.length} color="warning" /></FadeIn>
        <FadeIn><StatCard icon={FileText} label="Under Review" value={underReview.length} color="primary" /></FadeIn>
        <FadeIn><StatCard icon={CheckCircle2} label="Approved" value={approved.length} color="success" /></FadeIn>
        <FadeIn><StatCard icon={XCircle} label="Rejected" value={rejected.length} color="danger" /></FadeIn>
      </div>
